...
def index():
    return render_template(
        "description/index.html", text=mark2html("./ABOUT", get_locale())
    )
...
def about():
    return render_template(
        "description/about.html", text=mark2html("./AUTHOR", get_locale())
    )
...
def handle_file(file_name):
    if file_name == "libraries":
        ...
        return render_template(
            ...
            text=render_template("description/libraries.html", libs=libs),
        )
    ...
    return render_template(
        "description/index.html", text=mark2html(file_name[:delim_pos], get_locale())
    )
